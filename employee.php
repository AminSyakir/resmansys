...
<body>
    ...
    <div class="content">
        ...
        <br>
        <a class="add" href="add_employee.php">Add Employee</a>
        <br><br>
        ...
        <table border="1" cellpadding="10" cellspacing="0">
            ...
            <?php foreach ($users as $user) : ?>
                <tr>
                    ...
                    <td><img src="img/<?= $user["gambar"]; ?>" width="150"></td>
                    <td><?= $user["name"]; ?></td>
                    <td><?= $user["username"]; ?></td>
                    ...
                    <td><?= $user["level_"]; ?></td>
                    <td>
                        <a href="delete_employee.php?id=<?= $user["id"]; ?>" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
                <?php $i++; ?>
            <?php endforeach; ?>

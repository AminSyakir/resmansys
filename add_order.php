    ...
    <div class="content">
        ...
        <div class="div_login">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <select class="login_input" id="product_name" name="product_name">
                    <?php foreach ($products as $product) : ?>
                        <option value="<?= $product['product_name']; ?>"><?= $product['product_name']; ?></option>
                    <?php endforeach; ?>
                </select>

                <label class="login_label" for="order_quantity">Order Quantity</label>
                <select class="login_input" id="order_quantity" name="order_quantity">
                ...
                <select class="login_input" id="table_name" name="table_name">

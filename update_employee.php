    ...
    <div class="content">
        ...
        <div class="div_login">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <input class="login_input" type="text" name="name" id="name" value="<?= $user["name"]; ?>">

                <label class="login_label" for="contact_no">Contact No</label>
                <input class="login_input" type="text" name="contact_no" id="contact_no" value="<?= $user["contact_no"]; ?>">

                <label class="login_label" for="address_">Address</label>
                <input class="login_input" type="text" name="address_" id="address_" value="<?= $user["address_"]; ?>">

                <label class="login_label" for="gambar">Image</label>
                <img src="img/<?= $user["gambar"]; ?>" width="40"><br>
                <input class="login_input" type="file" name="gambar" id="gambar">

                <label class="login_label" for="level_">Role</label>
                <select class="login_input" id="level_" name="level_">
